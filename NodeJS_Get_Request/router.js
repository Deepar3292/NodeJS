function route(handle, pathname, response) {                           // defintion of the function route with specified parameters
    ...
    handle[pathname](response);                                        // if true handle object calls its assigned function in index.js
    } else {
